...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | pages-site-home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-site-home-home-module")]).then(__webpack_require__.bind(null, /*! ./pages/site/home/home.module */ "./src/app/pages/site/home/home.module.ts")).then((m) => m.SiteHomeModule),
    },
    {
        path: 'login',
    ...
    {
        path: 'post/:id',
        loadChildren: () => Promise.all(/*! import() | pages-site-post-post-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-site-post-post-module")]).then(__webpack_require__.bind(null, /*! ./pages/site/post/post.module */ "./src/app/pages/site/post/post.module.ts")).then((m) => m.PostModule),
    },
    {
        path: 'profile',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-site-profile-profile-module */ "pages-site-profile-profile-module").then(__webpack_require__.bind(null, /*! ./pages/site/profile/profile.module */ "./src/app/pages/site/profile/profile.module.ts")).then((m) => m.ProfileModule),
    },
];
...
/* harmony import */ var src_shared_state_app_app_action__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/shared/state/app/app.action */ "./src/shared/state/app/app.action.ts");
/* harmony import */ var src_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/shared/state/app/app.state */ "./src/shared/state/app/app.state.ts");
...
const _c0 = ["content"];
const _c1 = function (a0) { return { "dark-theme": a0 }; };
const _c2 = function (a0, a1) { return { "white": a0, "dark": a1 }; };
const _c3 = function () { return [""]; };
const _c4 = function () { return ["profile"]; };
class AppComponent {
    constructor(store, iconRegistry, sanitizer, window, platformId) {
        this.store = store;
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["isPlatformServer"])(platformId))
            svgUrl = `http://localhost:4200/${svgUrl}`;
        const x = this.sanitizer.bypassSecurityTrustResourceUrl(svgUrl);
        this.iconRegistry.addSvgIconSetInNamespace('app', x);
        this.store.select(src_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_3__["AppState"].darkMode).subscribe((d) => {
            this.isDark = d;
            this.updateTheme();
        });
    } // constructor
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function AppComponent_Template_mat_slide_toggle_change_23_listener($event) { return ctx.onDarkMode($event); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Store"] }, { type: _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconRegistry"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["DomSanitizer"] }, { type: Window, decorators: [{
...
/* harmony import */ var _ngxs_storage_plugin__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ngxs/storage-plugin */ "./node_modules/@ngxs/storage-plugin/__ivy_ngcc__/fesm2015/ngxs-storage-plugin.js");
...
/* harmony import */ var src_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/shared/state/app/app.state */ "./src/shared/state/app/app.state.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [{ provide: 'window', useFactory: windowFactory }], imports: [[
            ...
            _ngxs_storage_plugin__WEBPACK_IMPORTED_MODULE_10__["NgxsStoragePluginModule"].forRoot(),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_16__["AppComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_8__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_15__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _ngxs_store__WEBPACK_IMPORTED_MODULE_11__["ɵj"], _ngxs_storage_plugin__WEBPACK_IMPORTED_MODULE_10__["NgxsStoragePluginModule"], ngx_markdown__WEBPACK_IMPORTED_MODULE_12__["MarkdownModule"], 
        //
        _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"],
        _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"],
        _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_7__["MatToolbarModule"],
...
ThemeService.ɵfac = function ThemeService_Factory(t) { return new (t || ThemeService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_0__["DOCUMENT"])); };
...
/* harmony import */ var _app_action__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app.action */ "./src/shared/state/app/app.action.ts");
/* harmony import */ var _services_theme_theme_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/theme/theme.service */ "./src/shared/services/theme/theme.service.ts");
...
let AppState = class AppState {
    ...
    darkMode({ patchState }, action) {
        const darkMode = action.enable;
        this.applyTheme(darkMode);
        return patchState({ darkMode });
    } //darkMode()
    setPost({ patchState }, action) {
        return patchState({ post: action.post });
    }
    applyTheme(darkMode) {
        if (darkMode)
            this.theme.loadStyle('okaidia.css');
        else
            this.theme.loadStyle('vs.css');
    }
}; // class
AppState.ɵfac = function AppState_Factory(t) { return new (t || AppState)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_services_theme_theme_service__WEBPACK_IMPORTED_MODULE_4__["ThemeService"])); };
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Action"])(_app_action__WEBPACK_IMPORTED_MODULE_3__["DarkMode"])
], AppState.prototype, "darkMode", null);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Action"])(_app_action__WEBPACK_IMPORTED_MODULE_3__["SetPost"])
], AppState.prototype, "setPost", null);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppState, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"]
    }], function () { return [{ type: _services_theme_theme_service__WEBPACK_IMPORTED_MODULE_4__["ThemeService"] }]; }, { darkMode: [], setPost: [] }); })();
...
module.exports = __webpack_require__(/*! /home/osanda/Documents/workspace-techsfinity/techsfinity.github.io/src/main.ts */"./src/main.ts");
