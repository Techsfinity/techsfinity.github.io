...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-site-home-home-module"], {
        ...
        _createClass(BreakpointObserver, [{
          ...
          value: function isMatched(value) {
            ...
            return queries.some(function (mediaQuery) {
              return _this2._registerQuery(mediaQuery).mql.matches;
            });
          }
          /**
          ...
          value: function observe(value) {
            ...
            var observables = queries.map(function (query) {
              return _this3._registerQuery(query).observable;
            });
          ...
          value: function _registerQuery(query) {
            ...
            var queryObservable = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
              ...
              var handler = function handler(e) {
                return _this4._zone.run(function () {
    ...
    var CloseScrollStrategy = /*#__PURE__*/function () {
      function CloseScrollStrategy(_scrollDispatcher, _ngZone, _viewportRuler, _config) {
        ...
        this._detach = function () {
          ...
          if (_this5._overlayRef.hasAttached()) {
            _this5._ngZone.run(function () {
              return _this5._overlayRef.detach();
            });
          }
        };
      }
        ...
        value: function enable() {
          ...
          if (this._config && this._config.threshold && this._config.threshold > 1) {
            ...
            this._scrollSubscription = stream.subscribe(function () {
              var scrollPosition = _this6._viewportRuler.getViewportScrollPosition().top;

              if (Math.abs(scrollPosition - _this6._initialScrollPosition) > _this6._config.threshold) {
                _this6._detach();
              } else {
        ...
        value: function enable() {
          ...
          if (!this._scrollSubscription) {
            ...
            this._scrollSubscription = this._scrollDispatcher.scrolled(throttle).subscribe(function () {
              _this7._overlayRef.updatePosition(); // TODO(crisbeto): make `close` on by default once all components can handle it.


              if (_this7._config && _this7._config.autoClose) {
                var overlayRect = _this7._overlayRef.overlayElement.getBoundingClientRect();

                var _this7$_viewportRuler = _this7._viewportRuler.getViewportSize(),
                    width = _this7$_viewportRuler.width,
                    height = _this7$_viewportRuler.height; // TODO(crisbeto): include all ancestor scroll containers here once
    ...
    function () {
      var ScrollStrategyOptions = function ScrollStrategyOptions(_scrollDispatcher, _viewportRuler, _ngZone, document) {
        ...
        this.close = function (config) {
          return new CloseScrollStrategy(_this8._scrollDispatcher, _this8._ngZone, _this8._viewportRuler, config);
        };
        /** Block scrolling. */


        this.block = function () {
          return new BlockScrollStrategy(_this8._viewportRuler, _this8._document);
        };
        /**
        ...
        this.reposition = function (config) {
          return new RepositionScrollStrategy(_this8._scrollDispatcher, _this8._viewportRuler, _this8._ngZone, config);
        };
      ...
      var OverlayKeyboardDispatcher = /*#__PURE__*/function () {
        function OverlayKeyboardDispatcher(document) {
          ...
          this._keydownListener = function (event) {
            var overlays = _this9._attachedOverlays;
        ...
        _createClass(CdkConnectedOverlay, [{
          ...
          value: function _createPositionStrategy() {
            ...
            strategy.positionChanges.subscribe(function (p) {
              return _this20.positionChange.emit(p);
            });
            return strategy;
          }
          ...
          value: function _attachOverlay() {
            ...
            if (this.hasBackdrop) {
              this._backdropSubscription = this._overlayRef.backdropClick().subscribe(function (event) {
                _this21.backdropClick.emit(event);
              });
            } else {
              this._backdropSubscription.unsubscribe();
            }
        ...
        _createClass(FullscreenOverlayContainer, [{
          ...
          value: function _createContainer() {
            ...
            this._addFullscreenChangeListener(function () {
              return _this22._adjustParentForFullscreenChange();
            });
          }
        }, {
  ...
  function node_modulesAngularCdk__ivy_ngcc__Fesm2015PortalJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ComponentPortal = /*#__PURE__*/function (_Portal) {
      ...
      function ComponentPortal(component, viewContainerRef, injector, componentFactoryResolver) {
        ...
        _this23.component = component;
        _this23.viewContainerRef = viewContainerRef;
        _this23.injector = injector;
        _this23.componentFactoryResolver = componentFactoryResolver;
        return _this23;
      }
    ...
    var TemplatePortal = /*#__PURE__*/function (_Portal2) {
      ...
      function TemplatePortal(template, viewContainerRef, context) {
        ...
        _this24.templateRef = template;
        _this24.viewContainerRef = viewContainerRef;
        _this24.context = context;
        return _this24;
      }
    ...
    var DomPortal = /*#__PURE__*/function (_Portal3) {
      ...
      function DomPortal(element) {
        ...
        _this25 = _super4.call(this);
        _this25.element = element instanceof _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] ? element.nativeElement : element;
        return _this25;
      }
    ...
    var DomPortalOutlet = /*#__PURE__*/function (_BasePortalOutlet2) {
      ...
      _document) {
        ...
        _this26.outletElement = outletElement;
        _this26._componentFactoryResolver = _componentFactoryResolver;
        _this26._appRef = _appRef;
        _this26._defaultInjector = _defaultInjector;
        /**
        ...
        _this26.attachDomPortal = function (portal) {
          ...
          _this26.outletElement.appendChild(element);

          _get((_thisSuper = _assertThisInitialized(_this26), _getPrototypeOf(DomPortalOutlet.prototype)), "setDisposeFn", _thisSuper).call(_thisSuper, function () {
      ...
      _createClass(DomPortalOutlet, [{
        ...
        value: function attachComponentPortal(portal) {
          ...
          if (portal.viewContainerRef) {
            ...
            this.setDisposeFn(function () {
              _this27._appRef.detachView(componentRef.hostView);
        ...
        value: function attachTemplatePortal(portal) {
          ...
          viewRef.rootNodes.forEach(function (rootNode) {
            return _this28.outletElement.appendChild(rootNode);
          });
          this.setDisposeFn(function () {
    ...
    function () {
      var CdkPortalOutlet = /*#__PURE__*/function (_BasePortalOutlet3) {
        ...
        _document) {
          ...
          _this29._viewContainerRef = _viewContainerRef;
          /** Whether the portal component is initialized. */

          _this29._isInitialized = false;
          /** Emits when a portal is attached to the outlet. */

          _this29.attached = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
          /**
          ...
          _this29.attachDomPortal = function (portal) {
            ...
            portal.setAttachedHost(_assertThisInitialized(_this29));
            element.parentNode.insertBefore(anchorNode, element);

            _this29._getRootNode().appendChild(element);

            _get((_thisSuper2 = _assertThisInitialized(_this29), _getPrototypeOf(CdkPortalOutlet.prototype)), "setDisposeFn", _thisSuper2).call(_thisSuper2, function () {
              if (anchorNode.parentNode) {
                anchorNode.parentNode.replaceChild(element, anchorNode);
              }
            });
        ...
        _createClass(CdkPortalOutlet, [{
          ...
          value: function attachTemplatePortal(portal) {
            ...
            _get(_getPrototypeOf(CdkPortalOutlet.prototype), "setDisposeFn", this).call(this, function () {
              return _this30._viewContainerRef.clear();
            });
      ...
      var MatTooltip = /*#__PURE__*/function () {
        function MatTooltip(_overlay, _elementRef, _scrollDispatcher, _viewContainerRef, _ngZone, _platform, _ariaDescriber, _focusMonitor, scrollStrategy, _dir, _defaultOptions) {
          ...
          this._handleKeydown = function (event) {
            if (_this31._isTooltipVisible() && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event)) {
              event.preventDefault();
          ...
          _ngZone.runOutsideAngular(function () {
            _elementRef.nativeElement.addEventListener('keydown', _this31._handleKeydown);
          });
        }
          ...
          value: function _createOverlay() {
            ...
            strategy.positionChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["takeUntil"])(this._destroyed)).subscribe(function (change) {
              if (_this34._tooltipInstance) {
                if (change.scrollableViewProperties.isOverlayClipped && _this34._tooltipInstance.isVisible()) {
          ...
          value: function _setupPointerEvents() {
            ...
            if (!this._platform.IOS && !this._platform.ANDROID) {
              ...
              this._passiveListeners.set('touchend', touchendListener).set('touchcancel', touchendListener).set('touchstart', function () {
                ...
                clearTimeout(_this36._touchstartTimeout);
                _this36._touchstartTimeout = setTimeout(function () {
                  return _this36.show();
                }, LONGPRESS_DELAY);
              });
            }
            ...
            this._passiveListeners.forEach(function (listener, event) {
              _this36._elementRef.nativeElement.addEventListener(event, listener, passiveListenerOptions);
            });
          }
            ...
            if (!this._message && this._isTooltipVisible()) {
              ...
              this._ngZone.runOutsideAngular(function () {
                ...
                Promise.resolve().then(function () {
                  _this37._ariaDescriber.describe(_this37._elementRef.nativeElement, _this37.message);
                });
              });
            }
          }
  ...
  /***/
  function srcAppPagesSiteHomeHomeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSiteHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_shared_state_app_app_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/shared/state/app/app.action */
    "./src/shared/state/app/app.action.ts");
    /* harmony import */


    var _shared_utils_all_posts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../../shared/utils/all-posts */
    ...
    function HomeComponent_ng_template_16_a_14_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var post_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().post;
    ...
    function HomeComponent_ng_template_16_button_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_ng_template_16_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_ng_template_16_Template_button_click_11_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var post_r8 = ctx.post;

          var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r12.onPost(post_r8);
        });
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var postsMap = Object(_shared_utils_all_posts__WEBPACK_IMPORTED_MODULE_2__["getAllPosts"])();

          var values = _toConsumableArray(postsMap.values());
        ...
        key: "onPost",
        value: function onPost(post) {
          this.store.dispatch(new src_shared_state_app_app_action__WEBPACK_IMPORTED_MODULE_1__["SetPost"](post));
          this.router.navigate(["post/".concat(post.url)]);
        }
      }, {
        key: "onPageChange",
        value: function onPageChange(event) {
          this.p = event;
          this.old.nativeElement.scrollIntoView({
            behavior: 'smooth'
          });
        }
      }, {
        key: "onScroll",
        value: function onScroll(event) {// if (this.isScrooling == false)
          //   setTimeout(() => {
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Store"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChange", function HomeComponent_Template_pagination_controls_pageChange_15_listener($event) {
  ...
  /***/
  function srcAppPagesSiteHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SiteHomeModule", function () {
      return SiteHomeModule;
    });
    /* harmony import */
    ...
    var SiteHomeModule = function SiteHomeModule() {
      _classCallCheck(this, SiteHomeModule);
    };

    SiteHomeModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: SiteHomeModule
    });
    SiteHomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function SiteHomeModule_Factory(t) {
        return new (t || SiteHomeModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_8__["HomeRoutingModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_7__["NgxPaginationModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_6__["MatTooltipModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SiteHomeModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SiteHomeModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: [_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_8__["HomeRoutingModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_7__["NgxPaginationModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_6__["MatTooltipModule"]]
...
//# sourceMappingURL=pages-site-home-home-module-es5.js.map