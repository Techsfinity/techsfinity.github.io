...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-site-post-post-module"], {
  ...
  /***/
  function srcAppPagesSitePostPostRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSitePostPostComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/shared/state/app/app.state */
    "./src/shared/state/app/app.state.ts");
    /* harmony import */


    var src_shared_utils_all_posts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/shared/utils/all-posts */
    ...
    function PostComponent_button_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PostComponent_button_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 8);
    ...
    var PostComponent = /*#__PURE__*/function () {
      function PostComponent(store, activatedRoute, meta) {
        var _this = this;
        ...
        this.meta = meta;
        this.store.selectOnce(src_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_1__["AppState"].post).subscribe(function (post) {
          _this.post = post; // if post is null mean user is coming from a direct url

          if (!post) {
            var url = _this.activatedRoute.snapshot.params['id'];
            _this.post = Object(src_shared_utils_all_posts__WEBPACK_IMPORTED_MODULE_2__["getPostByUrl"])(url);
          }

          _this.addSocialMeta(_this.post);
        });
      } // constructor
      ...
      _createClass(PostComponent, [{
        ...
        key: "addSocialMeta",
        value: function addSocialMeta(post) {
          // Add facebook tags
          this.meta.addTags([{
            name: 'og:title',
            content: post.title
            ...
            name: 'og:url',
            content: "https://hrandika.github.io/post/".concat(post.url)
          }, {
            name: 'twitter:card',
  ...
  /***/
  function srcAppPagesSitePostPostModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _post_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./post.component */
    "./src/app/pages/site/post/post.component.ts");
    /* harmony import */
    ...
    PostModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: PostModule
    });
    PostModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function PostModule_Factory(t) {
        return new (t || PostModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], ngx_markdown__WEBPACK_IMPORTED_MODULE_4__["MarkdownModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"], _post_routing_module__WEBPACK_IMPORTED_MODULE_5__["PostRoutingModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_7__["MatButtonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](PostModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PostModule, [{
...
//# sourceMappingURL=pages-site-post-post-module-es5.js.map